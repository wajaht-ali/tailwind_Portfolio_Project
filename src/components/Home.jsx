  ...
  return (
    <div name='home' className="Hero w-full h-screen bg-[#0a192f] relative">
      ...
      <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full relative">
        ...
        <p className="text-[#d4dbee] py-4 max-w-[700px] text-[18px]">A junior software engineer and Computer Science graduate with six months of industry experience
          in developing and contributing to cutting-edge software architectures. I specialize in web technologies and am devoted to building 
          scalable, efficient, and innovative solutions.</p>
