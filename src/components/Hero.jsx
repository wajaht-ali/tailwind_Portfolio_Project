  ...
  return (
    <div className="Hero w-full h-screen bg-[#0a192f]">
      ...
      <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
        ...
        <div>
          <button className="text-white group w-[120px] text-center justify-evenly py-1 border-2 flex items-center hover:bg-pink-500 hover:border-pink-600 hover:ease-in-out hover:duration-300 hover:origin-bottom">View Work
